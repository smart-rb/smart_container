...
RSpec.describe 'Dependency observers (#observe, #unobserve, #clear_listeners)' do
  specify 'subscribe (#observe) to dependency changement (namespaces and deps) and listen' do
    ...
    container.register('storages.replica') { 'new_replica' }
    expect(database_interceptor).to contain_exactly('db_changed!', 'db_changed!')
    expect(cache_interceptor).to contain_exactly('cache_changed!', 'cache_changed!')
    expect(namespace_interceptor).to be_empty
  ...
  specify 'unsubscription from dependency changement (#unobserve, #clear_observers)' do
    ...
    container.register('api.google') { 'new_google' }
    container.register('api.kickbox') { 'new_kickbox' }
    ...
    container.register('api.google') { 'another_new_google' }
    container.register('api.kickbox') { 'another_new_kickbox' }
    ...
    container.register('api.google') { 'another_another_new_google' }
    container.register('api.kickbox') { 'another_another_new_kickbox' }
